...
const Register = () => {
  ...
  const handleChange = (e) => {
    ...
    const processedValue = name === 'phoneNumber' ? value.replace(/\D/g, '') : value;
  ...
  // Check the current step’s fields
  const validateStep = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-white to-purple-100 flex items-center justify-center px-4 sm:px-6 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl mx-auto flex items-center justify-center lg:justify-between relative z-10">
        ...
        <motion.div
          ...
          className="hidden lg:block w-1/2 max-w-lg"
        >
          <div className="p-8">
            ...
            <form className="space-y-5" onSubmit={handleSubmit} noValidate>
              ...
              <AnimatePresence mode="wait">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className={`${inputBaseClasses} pr-10 ${!validationState.password.isValid ? inputErrorClasses : inputValidClasses}`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="e.g., 0501234567 or +972501234567"
                ...
                {step === 3 && (
                  ...
                  >
                    <div>
                      <label htmlFor="preferredExchangeLocation" className="block text-sm font-medium text-gray-700 mb-1.5">Preferred Exchange Location</label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <select
                          ...
                          required
                          className={`appearance-none block w-full pl-10 pr-10 py-2.5 border rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50/60 hover:bg-white ${!validationState.preferredExchangeLocation.isValid ? inputErrorClasses : inputValidClasses} ${formData.preferredExchangeLocation ? 'text-gray-900' : 'text-gray-400'}`}
              ...
              <div className="flex items-center justify-between pt-4">
                <motion.button
                  ...
                  onClick={prevStep}
                  disabled={step === 1}
                  className={`inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-150 ${step === 1 ? 'text-gray-400 cursor-not-allowed' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-gray-400'}`}
                ...
                {step < 3 ? (
                  ...
                  <motion.button
                    type="submit"
                    disabled={isLoading}
                    className={`inline-flex items-center justify-center px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200 ${isLoading ? 'opacity-75 cursor-wait' : ''}`}
                    whileHover={{ scale: 1.02, y: -1 }}
                    whileTap={{ scale: 0.98 }}
